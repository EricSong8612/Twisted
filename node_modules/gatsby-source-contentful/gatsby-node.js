...
exports.sourceNodes = function () {
  var _ref3 = (0, _asyncToGenerator3.default)(regeneratorRuntime.mark(function _callee(_ref, _ref2) {
    ...
    var createNode, deleteNodes, touchNode, setPluginStatus, syncToken, _ref4, currentSyncData, contentTypeItems, defaultLocale, locales, entryList, existingNodes, assets, nextSyncToken, resolvable, foreignReferenceMap, newOrUpdatedEntries;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (store.getState().status.plugins && store.getState().status.plugins["gatsby-source-contentful"]) {
              syncToken = store.getState().status.plugins["gatsby-source-contentful"].status.syncToken;
            }
